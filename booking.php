...
include("db.php");
$SQLquery = "select bNumOfVisitors, bDate, bType, bNumOfDays, bMeals, bId from Booking";
...
$newlist = $list;
$search_names = array("bNumOfVisitors", "bDate", "bType", "bNumOfDays", "bMeals", "bId");
$search_label = array("Кількість відвідувачів", "Дата бронювання", "Тип відпочинку", "Кількість днів", "Харчування all-inclusive");
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $newlist = array();
    $formvals = array($_POST["bNumOfVisitors"], $_POST["bDate"], $_POST["bType"], $_POST["bNumOfDays"], $_POST["bMeals"]);
    ...
    <div id="main">
        ...
        <div class="modal_window" id="modal_window">
            ...
            <?php
                ...
                <br>
                <?php } ?>
                    <input type="hidden" name="table_name" value="Booking" />
        ...
        <table style='border: 0px'>
            ...
            <tr>
                ...
                <td>Тип відпочинку</td>
                <td>Кількість днів</td>
                <td>Харчування all-inclusive</td>
                <td></td>
                <td></td>
            </tr>
                ...
                <?php 
                    ...
                    ?>
                        <form method="post" action="editData.php">
                            <td>
                                <input type="text" name="bNumOfVisitors" value="<?php echo $array[0] ?>" />
                            </td>
                            <td>
                                <input type="text" name="bDate" value="<?php echo $array[1] ?>" />
                            </td>
                            <td>
                                <input type="text" name="bType" value="<?php echo $array[2] ?>" />
                            </td>
                            <td>
                                <input type="text" name="bNumOfDays" value="<?php echo $array[3] ?>" />
                            </td>
                            <td>
                                <input type="text" name="bMeals" value="<?php echo $array[4] ?>" />
                            </td>
                            <input type="hidden" name="table_name" value="Booking"/>
                            <input type="hidden" name="tableId" value="bId"/>
                    ...
                    <td>
                        <a href="booking.php?id=<?php echo $array["bId"]; ?>">Edit</a>
                    </td>
                    <?php } ?>
                    <td>
                    <a href="delete.php?id=<?php echo $array["bId"]; ?>&tableName=Booking&nameId=bId">Delete</a>
                    </td>
                </tr>
            <?php } ?>
